...
const NBA_PICKS = [
  {
    ...
    payout: "$18.75",
    edge: "Underdog value",
    signal: "Luka Doncic OUT (hamstring) — LeBron primary scorer. Jalen Williams also OUT for OKC. +650 underdog value. Playoffs R2 G1.",
  },
  {
    id: 2,
    status: "ACTIVE",
    ...
    awayTeam: "CLE",
    homeTeam: "DET",
    time: "Today, 7:00pm EDT",
    bet: "DET ML",
    betTeam: "DET",
    odds: "-150",
    wager: "$5.00",
    payout: "$8.33",
    edge: "Home court edge",
    signal: "Pistons home favorites · Cade Cunningham 23.9 pts / 9.9 ast · Detroit ATS 44-35 vs Cavs 33-49 · Playoffs R2 G1.",
  },
];
...
const PICKS = [
  {
    ...
    awayTeam: "CLE",
    homeTeam: "KC",
    time: "Today, 7:40pm EDT",
    bet: "CLE ML",
    betTeam: "CLE",
    odds: "-120",
    units: "1u",
    confidence: 70,
    macSignal: "ERA EDGE — Guardians starter advantage confirmed. Cleveland offense among AL's most consistent. ERA gap model triggered. Juice within -130 ceiling.",
    aceSignal: "MARKET SIGNAL — Guardians sharp side play. Line movement supports CLE. KC starter vulnerability flagged by ACE model.",
    combined: "LOCKED",
    tag: "⚡ LOCKED",
  },
  {
    ...
    awayTeam: "TEX",
    homeTeam: "NYY",
    time: "Today, 7:05pm EDT",
    bet: "TEX ML",
    betTeam: "TEX",
    odds: "+105",
    units: "1u",
    confidence: 67,
    macSignal: "ERA EDGE — deGrom 2.01 ERA vs Rodriguez ~4.50 ERA — gap 2.49 ✅. Rangers getting plus money with the better starter on the mound.",
    aceSignal: "UNDERDOG VALUE — TEX ML +105 is positive EV. deGrom elite when healthy. ACE confirms value bet threshold met. Positive CLV projected.",
    combined: "LOCKED",
    tag: "⚡ LOCKED",
  },
];
...
const NBA_BET_LOG = [
  { date: "MAY 05", game: "LAL @ OKC", bet: "LAL ML", odds: "+650", result: "PENDING", units: "—" },
  { date: "MAY 05", game: "CLE @ DET", bet: "DET ML", odds: "-150", result: "PENDING", units: "—" },
...
const BET_LOG = [
  { date: "MAY 05", game: "CLE @ KC", bet: "CLE ML", odds: "-120", result: "PENDING", units: "—" },
  { date: "MAY 05", game: "TEX @ NYY", bet: "TEX ML", odds: "+105", result: "PENDING", units: "—" },
  { date: "MAY 03", game: "SF @ TB", bet: "TB ML", odds: "-125", result: "WIN", units: "+$4.00" },
  { date: "MAY 03", game: "PHI @ MIA", bet: "PHI ML", odds: "-145", result: "WIN", units: "+$1.72" },
