...
const TASKS = [
  ...
  { task: "🟡 FCA: 3 jobs closed ✅ Noble $1,888 / Frankie $630 / FCA-003 $346. Total net: $2,894.35. Ask Joseph Noble for a Google review.", priority: "MED", pillar: "FCA" },
...
export default function Dashboard() {
  ...
  const [leads, setLeads] = useState<Lead[]>([
    ...
    { id: 3, name: "FCA-003 Client", phone: "", area: "Jacksonville, FL", service: "Concrete Slab — 9x8 (72 sqft) w/ Rebar", value: "$720", source: "Direct", notes: "🚧 IN PROGRESS Apr 24. HD truck secured $175 ✅. Bags + pour + payment pending.", stage: "Booked" },
  ]);
  const [jobs, setJobs] = useState<Job[]>([
    ...
    { id: 3, client: "FCA-003 Client", location: "Jacksonville, FL", jobType: "Concrete Slab — 9x8 72 sqft w/ Rebar", totalPrice: 760, depositPaid: 760, status: "Completed", notes: "✅ CLOSED Apr 24. Contract $720 + $40 tip = $760 total | Expenses $413.89 | Net Profit $346.11 (45.5% margin). Pour finished, customer happy." },
  ]);
  ...
  const [clients, setClients] = useState<Client[]>([
    ...
    { id: 3, name: "FCA-003 Client", phone: "", jobDone: "Concrete Slab 72 sqft w/ Rebar", notes: "🚧 IN PROGRESS Apr 24. HD truck $175 secured. Bags + pour + $720 collect pending.", repeat: false, referral: "Direct" },
  ]);
                    ...
                    <table className="w-full text-xs">
                      ...
                      <tbody>
                        {[
                          ...
                          { job: "FCA-003 — Slab 72 sqft w/ Rebar (Jacksonville)", revenue: 760, expenses: 413.89, date: "Apr 24" },
                        ...
                        <tr className="bg-slate-800/40">
                          ...
                          <td className="px-4 py-3 text-right text-red-400 font-black">$5,620.65</td>
                          <td className="px-4 py-3 text-right text-green-400 font-black text-sm">$2,864.35</td>
                          <td className="px-4 py-3 text-right text-cyan-400 font-black">33.8%</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
