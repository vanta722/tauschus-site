...
export default function Dashboard() {
  ...
  const [jobs, setJobs] = useState<Job[]>([
    ...
    { id: 3, client: "FCA-003 Client", location: "Jacksonville, FL", jobType: "Concrete Slab — 9x8 72 sqft w/ Rebar", totalPrice: 720, depositPaid: 500, status: "In Progress", notes: "🚧 IN PROGRESS Apr 24. Contract: $720 | $500 collected ✅ | $220 remaining | Truck $168.89 ✅ | Concrete + rebar $160 ✅ | Total spent: $328.89 | Pour pending." },
  ]);
